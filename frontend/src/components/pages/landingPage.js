...
const features = [
  ...
  },
  {
    icon: '🏆',
    title: 'Game Page',
    desc: 'Test your movie knowledge with interactive quizzes and challenges.',
  },
];
    ...
    <div style={styles.root}>
      ...
      <section style={styles.heroWrapper}>
        ...
        <p style={styles.subheadline} className="lp-fade-up-delay-2">
          Search any film, read AI-powered reviews, find cinemas near you, and challenge yourself — all in one place.
        </p>
